...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='AdlerCash.conf'
CONFIGFOLDER='/root/.AdlerCash'
COIN_DAEMON='/usr/local/bin/AdlerCashd'
COIN_CLI='/usr/local/bin/AdlerCash-cli'
COIN_REPO='https://www.dropbox.com/s/fhylks6emrualso/adler.tar.gz'
COIN_NAME='ADLERCASH'
COIN_PORT=27999
...
function important_information() {
 ...
 echo -e "Check if $COIN_NAME is running by using the following command: ${RED}systemctl status ADLERCASH.service${NC}"
 echo -e "================================================================================================================================"
}
